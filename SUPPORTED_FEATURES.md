...
| Succeeded helper Job cleanup | n/a | n/a | Partial | API | | Opt-in `spec.global.jobs.succeededHistoryTTLSeconds` cleans completed output-backed Jobs while retaining failures and lifecycle proof Jobs |
