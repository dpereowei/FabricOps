...
| Chaincode install/upgrade commands | yes | yes | Partial | | | Install/approve/commit and version+sequence upgrade reconciliation are covered by envtest; kind e2e upgrade smoke is pending |
