...
*/}}
{{- define "fabricops.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "fabricops.resourceName" -}}
{{- $fullname := include "fabricops.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "fabricops.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "fabricops.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
